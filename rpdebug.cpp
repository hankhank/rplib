...
void rp::AddLogSink(LogSink* new_sink)
{
...
static bool IsLogOld(const char* logname)
{
...
#ifdef WIN32
void rp::CleanUpOldLogs(string logdirectory)
{
    HANDLE hFind;
...
void rp::SetRepostLogLevel(LogSeverity severity)
{
